...
def monty_hall(switching = True, n_games = 90000, num_doors = 3, num_doors_car = 1, num_doors_contestant = 1, nums_doors_host = 1, num_cars_won = 1):
    ...
    for i in range(n_games):
        ...
        door_choice_host = random.sample(remaining_goats, nums_doors_host)
...
print(f"Number of doors opened by the host: {num_doors_host}")
...
print(f"Probability of winning by remaining: {theoretical_win_by_remaining} ")
print(f"Probability of winning by switching: {theoretical_win_by_switching} ")
print("----------------COMPARING RESULTS---------------")
print(f"Percentage difference of probabilities (winning by remaining): {percentage_difference_remaining}%")
print(f"Percentage difference of probabilities (winning_by_switching): {percentage_difference_switching}%")
print("------------------------------------------------")
